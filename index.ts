...
function insideScene(scene: Scene, p: Vector2) {
...
function castRay(scene: Scene, p1: Vector2, p2: Vector2): Vector2 {
  let start = p1;
  while (start.sqrDistanceTo(p2) < FAR_CLIPPING_PLANE ** 2) {
...
function renderGame(
  ...
  const minimapPosition = Vector2.zero().add(canvasSize(ctx).scale(0.02));
  const cellSize = ctx.canvas.width * 0.02;
  const minimapSize = sceneSize(scene).scale(cellSize);

  ctx.fillStyle = new Color(0, 0, 0, 1).toStyle();
...
let scene: Scene = [
  ...
  [null, Color.blue(), null, Color.cyan(), null, null, null, null, null, null],
  [null, Color.purple(), null, null, null, null, null, null, null, null],
  [null, null, null, null, null, null, null, null, Color.red(), null],
  [null, null, null, null, null, null, null, null, Color.red(), null],
  [null, null, null, null, null, null, null, null, Color.red(), null],
  [null, null, null, null, null, null, null, null, Color.red(), null],
  [null, null, null, null, null, null, null, null, Color.red(), null],
...
(() => {
  ...
  const player = new Player(
    sceneSize(scene).mul(new Vector2(0.5, 0.5)),
    Math.PI * 1.25
  );
